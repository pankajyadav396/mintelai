            ...
            <div className="px-4 max-w-[1180px] mx-auto">
                ...
                <div className='grid xl:grid-cols-4 lg:grid-cols-3 gap-6 576:grid-cols-2'>
                    {mintelizeList.map((obj, index) => {
                        return (
                            <div key={index} className='bg-light-green max-sm:max-w-[346px] sm:w-full mx-auto bg-opacity-20 !max-h-[562px] min-h-[350px] duration-300 group p-[1px] hover:bg-opacity-100 rounded-md shadow-small-green'>
