    ...
    return (
        <div className='px-4'>
            <div className='bg-purple-green p-1 mx-auto xl:mt-[120px] lg:mt-24 md:mt-20 sm:mt-16 mt-14 shadow-green-large max-w-[1340px] rounded-xl sm:rounded-2xl md:rounded-3xl lg:rounded-32'>
                <div className='max-w-[1340px] px-3 mx-auto bg-white rounded-xl sm:rounded-2xl md:rounded-3xl lg:rounded-32 py-12 md:py-16 lg:py-20'>
                    ...
                    <div className='grid sm:grid-cols-2 992:grid-cols-3 max-w-[1140px] mx-auto'>
                        {prospectingList.map((obj, index) => (
                            <div key={index} className={` ${index === 2 ? "justify-end max-992:relative max-992:left-[50%] max-992:translate-x-0 max-sm:left-0 mt-10 992:mt-0" : index === 1 ? "justify-center mt-10 sm:mt-0" : ""} flex max-992:justify-center items-start relative`}>
