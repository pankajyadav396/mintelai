        ...
        <div className="pt-[31px] bg-black relative max-h-[1001px]">
            ...
            <div className="max-w-[1140px] px-4 mx-auto">
                ...
                <div className="text-center max-w-[854px] mx-auto lg:pt-24 md:pt-20 pt-16 -mt-1">
                    ...
                    <div className="relative z-[2] lg:h-[550px] h-[400px] sm:h-[450px]  overflow-hidden">
                        <div className="mx-auto relative lg:max-w-[530px] md:max-w-[450px] max-w-[400px] ">
                            <span className="absolute z-[1] bg-light-green lg:h-[550px] h-[400px] sm:h-[500px] lg:w-[530px] w-[400px] md:w-[450px] left-0 mix-blend-color"></span>
                            <img src={gif} alt="img" className="lg:w-[530px] md:w-[450px] w-[400px] 2xl:scale-110" />
                        </div>
                    </div>
                </div>
            </div>
