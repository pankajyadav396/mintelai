        ...
        <div className="pt-[31px] bg-black relative max-h-[1001px]">
            ...
            <div className="max-w-[1140px] px-4 mx-auto">
                ...
                <div className="text-center max-w-[854px] mx-auto lg:pt-24 md:pt-20 pt-16 -mt-1">
                    ...
                    <button className="bg-light-green text-white rounded-lg hover:bg-white hover:text-light-green duration-300 hover:outline hover:outline-1 mb-0.5 outline-light-green py-4 px-[29px] font-proxima-normal font-normal text-base leading-122">Early Access</button>
