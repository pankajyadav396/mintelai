                ...
                <div className="flex flex-col 992:flex-row items-center justify-center 992:justify-between max-992:gap-8">
                    <div className="992:w-[447px] w-full">
                        ...
                        <form className='flex max-w-[446px] max-992:mx-auto justify-between rounded-4 relative z-[3] pl-4 border h-[52px] border-white border-opacity-25'>
                            ...
                            <button className='font-normal hover:bg-white duration-300 hover:text-light-green hover:border-light-green border border-white border-opacity-25 border-l-0  m-[-1px] flex items-center justify-cente font-proxima-normal rounded-4 text-nowrap text-white py-2.5 px-10 sm:p-[16.5px_47px] bg-light-green'>Sign Up</button>
                        </form>
                    </div>
                    <div className='992:w-[447px] w-full max-992:flex items-center justify-center flex-col'>
                        ...
                        <div className='flex gap-4 flex-wrap items-center justify-center'>
                            <a href="https://startup.google.com/"><img src={google} alt="google" className='hover:scale-90 duration-300 cursor-pointer' /></a>
                            <a href="https://www.microsoft.com/en-us/startups"><img src={microsoft} alt="microsoft" className='hover:scale-90 duration-300 cursor-pointer' /></a>
                            <a href="https://aws.amazon.com/startups"><img src={aws} alt="aws" className='hover:scale-90 duration-300 cursor-pointer' /></a>
                        </div>
                    </div>
                </div>
            </div>
